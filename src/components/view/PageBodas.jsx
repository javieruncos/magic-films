                ...
                <article className="my-5 pt-5 container">
                    <div className="my-5">
                        ...
                        <div className="row mt-5">
                            ...
                            <div className="col-12 col-md-4 col-md-4 col-lg-4">
                                <div className="cardMomentos-boda mb-5">
                                    <img src="https://www.webcasamiento.com/wp-content/uploads/2013/03/programa-fiesta-ramo.jpg" alt="" />
                                    <div className="d-flex justify-content-center pt-4 fs-2">
                ...
                <article className="my-5 pt-5 container">
                    <div className="row">
                        <div className="col-12 col-md-6 col-lg-4">
                            <div className="servicios-bodas color-servicios">
                                <div className="hearderServicios d-flex justify-content-center align-items-center">
                                    <span>
                                        <i className="bi bi-camera-reels-fill display-2 text-light"></i>
                                    </span>
                                </div>
                                <div className="bodyServicios text-center">
                        ...
                        <div className="col-12 col-md-6 col-lg-4">
                            <div className="servicios-bodas color-servicios2">
                                <div className="hearderServicios  d-flex justify-content-center align-items-center">
                                    <span>
                        ...
                        <div className="col-12 col-md-6 col-lg-4">
                            <div className="servicios-bodas color-servicios3">
                                <div className="hearderServicios d-flex justify-content-center align-items-center">
                                    <span>
